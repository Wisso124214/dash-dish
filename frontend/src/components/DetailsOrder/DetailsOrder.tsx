...
export default function DetailsOrder(data: Data) {
  ...
  return (
    ...
    >
      <div className='w-4/5 max-w-3xl bg-(--secondary-color) h-9/10 rounded-2xl text-foreground text-xl shadow-[0_0_10px_var(--box-shadow-color)] overflow-hidden flex flex-col'>
        ...
        <div className='flex-1 overflow-y-auto no-scrollbar::-webkit-scrollbar no-scrollbar'>
          ...
          <div className='flex flex-col p-6 gap-2'>
            ...
            <Button
              className='mt-8 mb-4 w-full bg-(--tertiary-color) hover:bg-(--tertiary-color-light) text-(--secondary-color) font-extrabold text-lg rounded-2xl '
              onClick={() => handleOrder()}
            >
              Order
            </Button>
